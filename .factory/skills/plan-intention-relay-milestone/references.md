...
| M5+, post-M5 retrospective alignment and the Slice 3/4 tails | `11-implementation-roadmap.md` (Milestone 5+), ADR 0035-0042, `reconciliation/source-of-truth-matrix.md`, `reconciliation/evidence-register.md` |
...
| M7, Plan/Build policies, physical plans, and Build Autopilot | `07-plan-and-build-modes.md`, `05-tools-workspace-and-hooks.md`, `04-sessions-runs-events-and-storage.md` |
