...
Navigation/personalization: **proved**. `files` is an allowed panel identifier in App but has no body in `TogglePanel.svelte`, therefore not a reachable Files feature.
