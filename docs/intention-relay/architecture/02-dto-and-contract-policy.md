...
| Provider DTO | Provider-neutral model request/stream/error contract, including advertised tool definitions. | `ModelRequestDto`, `ModelToolDefinitionDto`, `ModelEventDto`. |
