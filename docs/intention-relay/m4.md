...
accepted foundation is commit
`2889de9f151109934a61e61138d6db36724b0e36`
(`feat(m4): activate model provider foundation`). Package 1 passed `make quick`
and `make verify`; it does not implement durable model facts, runtime execution,
persistent subscriptions, or daemon fan-out.
