...
- Source areas: `crates/tauri-app/frontend`, `crates/tauri-app`, `crates/core`, `crates/tools`, `crates/config`, `crates/compression`, `crates/vfr`, `crates/prompt`, `crates/mcp`, `crates/skills`
