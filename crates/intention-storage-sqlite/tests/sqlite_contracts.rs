...
fn current_storage_schema_is_created_completely_and_remains_authoritative() {
    ...
    let expected_tables = [
        ...
        "held_recovered_runs",
        // Slice 3 harness tables.
        "harness_rules",
        "harness_rule_revisions",
        "harness_trigger_reasons",
        "harness_dossiers",
        "harness_checkpoints",
        "harness_journal",
        "harness_counters",
        // Slice 3 programmatic-caller policy tables.
        "programmatic_policies",
        "programmatic_policy_revisions",
        "programmatic_policy_snapshots",
        "programmatic_policy_confirmations",
        "programmatic_authorization_corridors",
        "programmatic_policy_drafts",
        "programmatic_policy_counters",
        "programmatic_policy_reservations",
        // Slice 3 Goal-domain and verification tables.
        "goals",
        "goal_revisions",
        "goal_parent_links",
        "goal_session_links",
        ...
        "goal_gate_results",
        "goal_memory_cards",
        "goal_memory_relations",
        "goal_skill_cards",
        "goal_role_cards",
        "refinement_drafts",
        "conversation_summaries",
        "compaction_working_forms",
        "verifier_authorities",
        "verifier_audit_baselines",
        "verifier_audit_evidence",
        "verifier_audit_verdicts",
        "verifier_target_mutations",
    ];
    ...
    let expected_indexes = [
        ...
        // Slice 3 harness indexes.
        "harness_rules_by_project",
        "one_pending_harness_trigger",
        "harness_trigger_reasons_by_harness",
        "harness_dossiers_by_harness",
        "one_current_harness_checkpoint",
        // Slice 3 programmatic-caller policy indexes.
        "programmatic_policies_by_project",
        "programmatic_policies_by_goal",
        "programmatic_confirmations_by_root",
        "one_active_policy_corridor_per_root",
        "one_pending_policy_draft",
        "programmatic_reservations_by_run",
        // Slice 3 Goal-domain and verification indexes.
        "goals_by_project",
        "goals_by_session",
        "one_obligatory_parent_per_goal",
        "one_session_link_per_goal",
        "goal_gates_by_goal",
        "goal_gate_templates_by_owner",
        "goal_memory_cards_by_owner",
        "goal_skill_cards_by_owner",
        "one_pending_refinement_draft",
        "verifier_audit_baselines_by_target",
    ];
